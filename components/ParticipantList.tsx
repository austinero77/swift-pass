...
import { Search, Eye, Trash2, User, Users, CheckCircle, Copy, Check, Loader } from 'lucide-react';
...
export const ParticipantList: React.FC<ParticipantListProps> = ({ participants, onView, onDelete, isLoading }) => {
            ...
            <tbody className="divide-y divide-slate-700/30">
              {
                isLoading ? (
                  // <tr>
                  //   <td colSpan={5} className="px-6 py-20 text-center text-slate-500 text-sm font-medium uppercase tracking-widest">Loading Partipants....</td>
                  // </tr>
                  <tr>
                    <td colSpan={5} className="px-6 py-20 text-center">
                      <div className="flex flex-col items-center gap-3">
                        <Loader className="animate-spin text-blue-500" size={40} />
                        <p className="text-slate-500 text-[12px] font-black uppercase tracking-[0.3em]">
                          Fetching Guest Records...
                        </p>
                      </div>
                    </td>
                  </tr>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-white font-bold text-sm tracking-tight uppercase">
                            {p.firstName || p.lastName ? `${p.firstName} ${p.lastName}` : ((p as any).fullName || 'Unknown')}
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4">
      ...
      <div className="md:hidden space-y-4">
        {
          ...
          isLoading ?
            (
              ...
              //       <p className="text-sm font-medium">Loading Partipants....</p>
              //     </div>
              //   </td>
              // </tr>
              <tr>
